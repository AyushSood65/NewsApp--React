...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=462460ca81b4480ca23aad7735527b30&page=1&pageSize=${this.props.pageSize}`;
    ...
    render() {
        return (
            <div className='container my-3'>
                <h1 id="heading" className='text-center'>NewsByAyush - Top Headlines</h1>
